    ...
    if(isset($_REQUEST['submit']))
    {
        ...
        if (in_array(null, $data, true) || in_array('', $data, true)) {
            ...
            if(empty($return['email']) && empty($return['password'])) {
                ...
                $message = "<div class='alert alert-danger'>Email and Password not Matched.</div>";
            } 
            else if($return['status'] == '0') {
                $message = "<div class='alert alert-danger'>Your Account is Suspended. (Please Contact Admin)</div>";
            }
            else {
                $_SESSION['user_login_detail'] = $return;
                // header("Location: ".base_url."admin?l_id=".$return['id']);
                header("Location: ".base_url."admin");
                exit;
            }
        }
...
<head>
    ...
    <title>Login | Convert Application</title>
                ...
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" autocomplete="off">
                    <div class="shadow card border-secondary border-3 p-4 rounded bg-white">
                        <div class="card-header">
                            ...
                            <h4 class="text-center">To Start Your Session</h4>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="row text-center">
                                <div class="col-sm-12">
                                    <a href="<?= base_url."admin/users/forget.php"; ?>">
